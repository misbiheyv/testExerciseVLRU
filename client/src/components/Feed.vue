  ...
  mounted() {
    ...
    const callback = (entries) => {
      if (
        ...
        this.currentSection <= this.maxSectionCount
      ) {
  ...
  methods: {
    normalizeTags(tags) {
      ...
      return tags
        .split(",")
        .map((tag) => {
          if (Object.hasOwnProperty.call(o, tag)) return o[tag];
        })
        .join(" ")
        .toLowerCase();
    },
