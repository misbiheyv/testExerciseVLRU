  ...
  <div class="edit__wrapper">
    ...
    <div class="edit__content">
      <div class="card-container">
        ...
        <textarea class="description_input" v-model="card.description">
Описание задачи 4</textarea
        >

        <footer class="card__footer">
          <my-button class="action-btn" @click="onClickSave"
            >Сохранить</my-button
          >
        </footer>
      </div>
